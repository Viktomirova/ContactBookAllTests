...
namespace ApiTests
{
    public class ApiTest
    {
        ...
        public void Test_SearchClients_CheckFirstResylt()
        {
            ...
            request.AddUrlSegment("keyword", "michael");
            ...
            Assert.That(response.StatusCode, Is.EqualTo(HttpStatusCode.OK));
            Assert.That(contacts.Count, Is.GreaterThan(0));
            Assert.That(contacts[0].firstName, Is.EqualTo("Michael"));
            Assert.That(contacts[0].lastName, Is.EqualTo("Jackson"));
        }
        ...
        public void Test_CreateContact_ValidData()
        {
            ...
            var body = new
            {
                firstName = "Giulia" + DateTime.Now.Ticks,
                lastName = "Giuliany" + DateTime.Now.Ticks,
                email = + DateTime.Now.Ticks + "giulia@abv.bg",
